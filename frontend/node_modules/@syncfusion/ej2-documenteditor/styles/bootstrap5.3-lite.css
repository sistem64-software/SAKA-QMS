...
.e-de-ui-wfloating-menu .e-de-ui-menuitem-none {
  border: 0;
  -webkit-box-shadow: inset 0 0 0 1px var(--color-sf-border);
...
.e-de-rp-btn-enforce {
  ...
  opacity: 0.87;
  border-radius: 2px;
  -webkit-box-shadow: 0 8px 12px rgba(var(--color-sf-black), 0.15);
...
.e-de-ctnr-group-btn .e-btn:focus {
  ...
  -webkit-box-shadow: 0 0 0 0 var(--color-sf-secondary-bg-color-pressed);
