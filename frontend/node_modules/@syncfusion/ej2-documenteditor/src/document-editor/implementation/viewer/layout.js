 ...
 */
    ...
    Layout.prototype.updateFootnoteHeight = function (table, isUpdateFootHeight) {
        if (!this.isInitialLoad && !table.isInsideTable && !isNullOrUndefined(table.bodyWidget) && !isNullOrUndefined(table.bodyWidget.page.footnoteWidget) &&
            ...
            var page = table.bodyWidget.page;
    ...
    Layout.prototype.shiftWidgetsForPara = function (paragraph, viewer) {
        ...
        for (var i = 0; i < paragraph.getSplitWidgets().length; i++) {
            ...
            if (this.isFitInClientArea(widget, viewer, footWidget) || (viewer.clientActiveArea.height < widget.firstChild.height && this.viewer.clientActiveArea.y === this.viewer.clientArea.y)
